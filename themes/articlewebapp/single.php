<?php get_header(); ?>
    ...
    <?php if( $query->have_posts()): ?>
        ...
        <div class="articulos__container">
            ...
            <div class="articulos__items-single">
                <div class="articulos__img-single">
                    <div class="articulos__info-single">
                        <span class="button__back"><a href="/"><</a></span>
                    ...
                    <img src="<?php the_field('imagen') ?>" alt="imagen-<?php echo $count ?>" class="articulo-img-single">
                </div>
                <div class="articulos__content">
                    <p class="articulos__description"><?php the_field('informacion_completa') ?></p>
                </div>
            </div>
            <?php endwhile ?>
        </div>
        <div class="articulos__comments">
